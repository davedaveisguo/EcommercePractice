...
export class ChekoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.stripe = Stripe('pk_test_vJ5PlFDyCAHLQUc5nvrcIk9200soqmO1Cu');
  ...
  async submitOrder() {
    ...
    try {
      ...
      if (paymentResult.paymentIntent) {
        // delete basket, navigate to success page and pass order info
